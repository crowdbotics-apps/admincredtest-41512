"""
Django settings for admincredtest_41512 project.
...
ROOT_URLCONF = 'admincredtest_41512.urls'
...
WSGI_APPLICATION = 'admincredtest_41512.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "admincredtest_41512 API",
    "DESCRIPTION": "API documentation for admincredtest_41512 App",
    "VERSION": "v1",
}
